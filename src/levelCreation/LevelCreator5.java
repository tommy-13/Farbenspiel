...
public class LevelCreator5 {
	
	private static final int levelNr = 40;
	...
	private static Level createLevel2() {
		FieldColor[][] curCol = {
				{dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen},
				{dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen},
				{dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen},
				{dgreen, dgreen, dgreen, red,    red,    red,    red,    red,    red,    red,    red},
				{red,    red,    red,    red,    red,    red,    red,    red,    red,    red,    red},
				{red,    blue,   blue,   blue,   blue,   blue,   blue,   blue,   blue,   blue,   blue},
		...
		FieldColor[][] wishCol = {
				{dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen},
				{dgreen, blue,   blue,   blue,   blue,   blue,   blue,   blue,   blue,   blue,   dgreen},
				{dgreen, blue,   red,    blue,   red,    blue,   red,    red,    red,    blue,   dgreen},
				{dgreen, blue,   red,    blue,   red,    blue,   blue,   blue,   red,    blue,   dgreen},
				{dgreen, blue,   red,    red,    red,    blue,   red,    red,    red,    blue,   dgreen},
				{dgreen, blue,   blue,   blue,   red,    blue,   red,    blue,   blue,   blue,   dgreen},
				{dgreen, blue,   blue,   blue,   red,    blue,   red,    red,    red,    blue,   dgreen},
				{dgreen, blue,   blue,   blue,   blue,   blue,   blue,   blue,   blue,   blue,   dgreen},
				{dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen, dgreen}
		};
